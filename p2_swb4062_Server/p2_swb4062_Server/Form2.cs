...
namespace p2_swb4062_Server
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            placingShips = true;
            lStatus.Text = "Click a square on the Server grid to palce your Battleship.";
        ...
        //This event occurs when the Server player clicks on the Server grid
        private void dataGridView2_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            //each time the Server player clicks, we increment the clickCount to determine which action to take
            clickCount++;
            ...
            cell = dataGridView2.Rows[rowIndex].Cells[colIndex];
                    ...
                    {   //once the user clicks a different square
                        ...
                        {   //If it's above/below the original click, we place the ship vertically based on its size
                            ...
                            {   //This if statement ensures that the chosen placement will allow the ship to fit on the grid
                                ...
                                dataGridView2[lstShips[0].Position_Col, lstShips[0].Position_Row + 1].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[0].Position_Col, lstShips[0].Position_Row + 2].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[0].Position_Col, lstShips[0].Position_Row + 3].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[0].Position_Col, lstShips[0].Position_Row + 4].Style.BackColor = Color.Gray;
                            }
                            else
                        ...
                        {   //If the second chosen cell is left/right of the original click, we place the ship horizontally
                            ...
                            {   //and again ensure that this will fit on the grid from left to right
                                dataGridView2[lstShips[0].Position_Col + 1, lstShips[0].Position_Row].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[0].Position_Col + 2, lstShips[0].Position_Row].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[0].Position_Col + 3, lstShips[0].Position_Row].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[0].Position_Col + 4, lstShips[0].Position_Row].Style.BackColor = Color.Gray;
                            }
                            else
                        ...
                        s.ExtentUnits = 4;
                        lstShips.Add(s);
                        lStatus.Text = "Click a square on the Server grid to place your Cruiser.";
                    }
                }
                //See previous comments for "Battle Ship" placement
                if (currentShip.Equals("Cruiser"))
                {
                    ...
                    if (clickCount == 2)
                    {
                        if (cell.RowIndex > lstShips[1].Position_Row || cell.RowIndex < lstShips[1].Position_Row)
                        {
                            ...
                            {
                                dataGridView2[lstShips[1].Position_Col, lstShips[1].Position_Row + 1].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[1].Position_Col, lstShips[1].Position_Row + 2].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[1].Position_Col, lstShips[1].Position_Row + 3].Style.BackColor = Color.Gray;
                            }
                            else
                            {
                                dataGridView2[lstShips[1].Position_Col, lstShips[1].Position_Row - 1].Style.BackColor = Color.Gray;
                        ...
                        else if (cell.ColumnIndex > lstShips[1].Position_Col || cell.ColumnIndex < lstShips[1].Position_Col)
                        {
                            ...
                            {
                                dataGridView2[lstShips[1].Position_Col + 1, lstShips[1].Position_Row].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[1].Position_Col + 2, lstShips[1].Position_Row].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[1].Position_Col + 3, lstShips[1].Position_Row].Style.BackColor = Color.Gray;
                            }
                            else
                            {
                                dataGridView2[lstShips[1].Position_Col - 1, lstShips[1].Position_Row].Style.BackColor = Color.Gray;
                        ...
                        s.ExtentUnits = 3;
                        lstShips.Add(s);
                        lStatus.Text = "Click a square on the Server grid to place your Submarine.";
                    }
                }
                //See previous comments for "Battle Ship" placement
                if (currentShip.Equals("Submarine"))
                {
                    ...
                    if (clickCount == 2)
                    {
                        if (cell.RowIndex > lstShips[2].Position_Row || cell.RowIndex < lstShips[2].Position_Row)
                        {
                            ...
                            {
                                dataGridView2[lstShips[2].Position_Col, lstShips[2].Position_Row + 1].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[2].Position_Col, lstShips[2].Position_Row + 2].Style.BackColor = Color.Gray;
                            }
                            else
                            {
                                dataGridView2[lstShips[2].Position_Col, lstShips[2].Position_Row - 1].Style.BackColor = Color.Gray;
                        ...
                        else if (cell.ColumnIndex > lstShips[2].Position_Col || cell.ColumnIndex < lstShips[2].Position_Col)
                        {
                            ...
                            {
                                dataGridView2[lstShips[2].Position_Col + 1, lstShips[2].Position_Row].Style.BackColor = Color.Gray;
                                dataGridView2[lstShips[2].Position_Col + 2, lstShips[2].Position_Row].Style.BackColor = Color.Gray;
                            }
                            else
                            {
                                dataGridView2[lstShips[2].Position_Col - 1, lstShips[2].Position_Row].Style.BackColor = Color.Gray;
                        ...
                        s.ExtentUnits = 2;
                        lstShips.Add(s);
                        lStatus.Text = "Click a square on the Server grid to place your Destroyer.";
                    }
                }
                //See previous comments for "Battle Ship" placement
                if (currentShip.Equals("Destroyer"))
                {
                    ...
                    if (clickCount == 2)
                    {
                        if (cell.RowIndex > lstShips[3].Position_Row || cell.RowIndex < lstShips[3].Position_Row)
                        {
                            ...
                            {
                                dataGridView2[lstShips[3].Position_Col, lstShips[3].Position_Row + 1].Style.BackColor = Color.Gray;
                            }
                            else
                            {
                                dataGridView2[lstShips[3].Position_Col, lstShips[3].Position_Row - 1].Style.BackColor = Color.Gray;
                        ...
                        else if (cell.ColumnIndex > lstShips[3].Position_Col || cell.ColumnIndex < lstShips[3].Position_Col)
                        {
                            if (lstShips[3].Position_Col + 1 <= 10)
                            {
                                dataGridView2[lstShips[3].Position_Col + 1, lstShips[3].Position_Row].Style.BackColor = Color.Gray;
                            }
                            else
                            {
                                dataGridView2[lstShips[3].Position_Col - 1, lstShips[3].Position_Row].Style.BackColor = Color.Gray;
                        ...
                        currentShip = "";
                        placingShips = false;
                        lStatus.Text = "Click a blank square on the Server grid to finish placing your ships.";
            ...
            else
            {
                ...
                lInstruct.Text = "Click a square on the Client's grid to attack!";
            }
        }
        ...
        //This handles the attacks on the Client
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            //if the user clicks the Client's grid to attack and it's currently their turn
            if (!placingShips && isYourTurn)
            {
                ...
                responseCell = dataGridView1.Rows[rowIndex].Cells[colIndex];
                //and prepare to ship that decision off to the client to see if we hit or missed
        ...
        private void send()
        {   //as long as we have a connection to the client
            while (Program.c.Connected)
            {   //we check to see which thread is running this because sometimes the Receiver thread needs to use this function as well
                ...
                if (Thread.CurrentThread.Name.Equals("Sender") && msg.Equals("GameOver"))
                    break;
                //Here, we inform the Client if their most recent attack landed or missed
                if ((response.Equals("Hit") || response.Equals("Miss")) && !isYourTurn)
                {
                    Program.w.Write(response);
                    Program.w.Flush();
                }
                //But if it's the Server's turn, we send our attack over to the Client for evaluation
                if (!response.Equals("Hit") && !response.Equals("Miss") && !response.Equals("") && isYourTurn)
                {
                    ...
                    isYourTurn = false;
                    this.Invoke(new MethodInvoker(() => lStatus.Text = "Client's Turn!")); 
                }
        ...
        {   //as long as we have a connection to the Client:
            ...
            {   //see if there's a message
                ...
                //If the Client is not telling us about our previous attack, then we must be receiving some coordinates
                ...
                {   //we break up those coordinates so that we can evaluate them
                    ...
                    DataGridViewCell msgCell = dataGridView2.Rows[row].Cells[col];
                    //if the cell is gray, it means we have a ship there
                    if (msgCell.Style.BackColor == Color.Gray)
                    {   //so we mark it red to indicate that it's been hit and prepare to tell the Client
                    ...
                    isYourTurn = true;
                    this.Invoke(new MethodInvoker(() => dataGridView1.Enabled = true));
